...
public class ChamarRelatorio {
        ...
        try {
            ...
            //Connection conn = DriverManager.getConnection("jdbc:mysql://localhost/db_gestao", "root", "mysql");
            Connection conn = DriverManager.getConnection("jdbc:mysql://localhost/db_gestao", "root", "root");
